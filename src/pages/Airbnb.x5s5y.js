...
/*
If you need to change the image you need to add a mouseIn function on it and add the same propeties like on the on'es below (image90 and image89)

The boxes mouseOut code SHOULD NOT change
...
// when hovered over image
export function image90_mouseIn(event) {
	let fadeOptions = {
		"duration":   400,
  		"delay":      200
	};

	$w('#box126').show("fade", fadeOptions);

}

// when hovered over image
export function image89_mouseIn(event) {
	let fadeOptions = {
		"duration":   400,
  		"delay":      200
	};

	$w('#box127').show("fade", fadeOptions);
}

// when mouse leaves the box
export function box126_mouseOut(event) {
	let fadeOptions = {
		"duration":   400,
  		"delay":      200
	};

	$w('#box126').hide("fade", fadeOptions);
}


// when mouse leaves the box
export function box127_mouseOut(event) {
	let fadeOptions = {
		"duration":   400,
  		"delay":      200
	};

	$w('#box127').hide("fade", fadeOptions);
}
//----------Hover-----------//
