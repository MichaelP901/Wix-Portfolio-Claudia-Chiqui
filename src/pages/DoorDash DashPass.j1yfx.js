...
*	 @param {$w.MouseEvent} event
*/
export function image111_mouseIn(event) {
	...
	$w("#box133").show("fade", fadeOptions);
...
*	 @param {$w.MouseEvent} event
*/
export function box133_mouseOut(event) {
	let fadeOptions = {
		"duration":   400,
  		"delay":      200
	};

	$w("#box133").hide("fade", fadeOptions);
}
...
*	 @param {$w.MouseEvent} event
*/
export function image112_mouseIn(event) {
	let fadeOptions = {
		"duration":   200,
  		"delay":      100
	};

	$w("#box132").show("fade", fadeOptions);
}
...
*	 @param {$w.MouseEvent} event
*/
export function box132_mouseOut(event) {
	let fadeOptions = {
		"duration":   200,
  		"delay":      100
	};

	$w("#box132").hide("fade", fadeOptions);
}
...
*	 @param {$w.MouseEvent} event
*/
export function vectorImage10_click_1(event) {
	$w('#box20').hide();
	$w('#box135').hide();
	$w("#vectorImage10").hide();
}
